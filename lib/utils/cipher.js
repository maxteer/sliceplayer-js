"use strict";Object.defineProperty(exports, "__esModule", {value: true});var _2 = require('./');
...
const functions = {
 ...
 async function createCipher(jsURL) {
  let cipher = cipherCache[jsURL];
  if (!cipher) {
    const js = await _2.loadURL.call(void 0, jsURL);
